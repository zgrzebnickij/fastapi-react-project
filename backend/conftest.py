...
@pytest.fixture
def test_post(test_db, test_user) -> models.Post:
    """
    post for testing
    """
    post = models.Post(
        ...
        content='This is a content of test post'
    )
    test_db.add(post)
    test_db.commit()
    return post
...
@pytest.fixture
def test_post_2(test_db, test_user_2) -> models.Post:
    """
    post for testing
    """
    post = models.Post(
        ...
        image_url='/images/test2Image.png',
        source_url='sourceUrl2',
        content='This is a content of test post 2'
    )
    test_db.add(post)
    test_db.commit()
    return post
